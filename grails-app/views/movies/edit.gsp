...
<html>
	...
	<body>
		<a href="#edit-movies" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-movies" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${moviesInstance?.version}" />
				<fieldset class="form">
